...
public class CompareTextUtils {
	...
	private static void compareValidReaders(final BufferedReader expected, final BufferedReader actual)
			throws IOException {
	...
	private static String[] readLines(final BufferedReader expected, final BufferedReader actual) throws IOException {
